...
class DisentangleVAE(PytorchModel):
    ...
    def run(self, x, c, pr_mat, tfr1, tfr2, tfr3, confuse=True):
        ...
        return (
            pitch_outs, dur_outs, dist_chd, dist_rhy, 
    ...
    def loss_function(self, x, c, recon_pitch, recon_dur, dist_chd,
        ...
        return (
            ...
            kl_rhy, chord_loss, root, chroma, bass
        )
    ...
    def posterior_sample(self, pr_mat, c, scale=None, 
                         sample_chd=True, sample_txt=True):
    ...
    def prior_sample(self, x, c, sample_chd=False,
                     sample_rhy=False, scale=1.):
    ...
    def interp_path(self, z1, z2, interpolation_count=10):
        ...
        def slerp2(p0, p1, t):
            ...
            return (
                np.sin((1.0 - t) * omega)[:, None]
                /so*p0[None] + np.sin(t * omega)[:, None]
                /so*p1[None]
            )
